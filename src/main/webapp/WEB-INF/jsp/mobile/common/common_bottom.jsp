...
<%--<script type="text/javascript" src="${BASE_URL}resources/assets/weui/zepto.min.js?ver=${VERSION}"></script>--%>
...
<script src="https://cdn.bootcss.com/jquery.form/4.0.1/jquery.form.min.js"></script>
<%--图片展示--%>
