...
<link rel="stylesheet" href="${BASE_URL}resources/assets/weui/style/weui.min.css?ver=${VERSION}">
<link rel="stylesheet" href="${BASE_URL}resources/assets/weui/example.css?ver=${VERSION}">
