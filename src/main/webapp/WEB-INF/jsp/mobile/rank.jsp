        ...
        <div class="weui-cell weui-cell_example">
            ...
            <div class="weui-cell__bd">
                ...
                <div class="weui-cell__desc">
                    <c:forEach items="${myRank.IMG_PATHS.split(Attribute.SERVICE_SPLIT)}" var="IMG_PATH">
                        <img class="weui-cell__achievement"
                             src="${WEBCONFIG_FILE_SERVER_URL}${Url.FILE_SERVER_PREVIEW_URL}${IMG_PATH}">
                    </c:forEach>
                </div>
            </div>
            <div class="weui-cell__ft ${fns:trueOrFalse(myRank.WECHAT_RANK <= 3, 'strong' ,'')}">${myRank.CLOCKIN_COUNT}
                <a href="javascript:;" class="paw-button liked confetti">
                    <div class="text">
                        <svg>
